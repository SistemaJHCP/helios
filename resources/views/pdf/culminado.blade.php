...
<body>
    ...
    <div id="centrarCabecera">
            ...
            <div class="titulo"><center><b>Informe sobre folios<br>del BBVA</b></center></div>
            <div class="logo"><center><b>CULMINADO</b></center></div>
            {{-- <div class="logo"><img src="{{ url('imagenes/logo-mini.png') }}"></div> --}}
    ...
    <style>
        ...
        .cintillo5 {width: 676px; height: 16px; border: 1px solid #007996; background: #007996; padding-top: 2px; color:white;text-align: center}
        .cintillo6 {width: 676px; height: 16px; border: 1px solid #007996; background: #007996; padding-top: 2px; color:white;text-align: center; margin-bottom: 20px;}
        ...
        .cintillo7 {width: 676px; height: 16px; border: 1px solid #007996; background: #007996;margin-top:210px; padding-top: 2px; color:white;text-align: center; margin-bottom: 20px; margin-bottom: 20px;}
    ...
    <div class="2daHoja">
        <div class="opciones">
            ...
            <div class="cintillo6">COSTO DEL SERVICIO Y OBSERVACIÓN DEL CLIENTE</div>
            <div class="costosTotales"><b>COSTOS:</b> <br>{{ $precio->costo }}</div>
            <div class="resultadoNegativo"><b>OBSERVACIÓN DEL CLIENTE: </b><br> {{ $observacion->observacion }} </div>


            </div>
            <div class="cintillo7">REQUERIMIENTOS DE OBRA</div>
            <div class="tabla">
                <table border="1">
                    <thead>
                        <tr>
    ...
    <div style="font-size: 22px;text-align:center;">Informe fotográfico</div>
    <style>
        #imgParaPdf{
            width: 219px; height: 138px; margin-top: 6px;
        }
    </style>
        ...
        @foreach ($arreglo as $arrg)
            ...
            <p style="text-align:justify;">
                <div style="font-size:10px;">Fecha: <?php  print($arrg[0][1]);?></div><br>
                <b>Descripcion: </b><div style="text-align:justify;"><?php  print($arrg[0][0]);?></div>
            </p>
            <br>
            <p>
                @for ($i = 0; $i < count($arrg[1]); $i++)
                    <img src="{{ url($arrg[1][$i]) }}" id="imgParaPdf">
                @endfor
            </p>

            <div style="width:100%; height:-8px;background:#007996;"></div>
        @endforeach
