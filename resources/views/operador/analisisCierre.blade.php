...
{{-- ------------------------------------------------------------ --}}
                        ...
                        <center><a href="{{ route('operador.folioEnEspera') }}"><button class="btn btn-primary btn btn-flat btn-lg"><i class="fa fa-mail-reply"></i> Regresar</button></a></center>
    ...
    <div class="col-md-8">
    @if($folio->disponibilidad == "cerrado por coord")
        <a href="#" id="finalizar">
            <div class="info-box" style="background:#3c8dbc;color:white;">
                <span class="info-box-icon"><i class="fa fa-check" style="font-size:60px;margin-top:16px;"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Finalizar</span>
                    <span class="info-box-number">proyecto</span>
    ...
    @elseif($folio->disponibilidad == "culminado")
        <a href="{{ route('operador.informeAprobatoria', $id) }}" id="impPfd">
            <div class="info-box" style="background:#d64545;color:white;">
                <span class="info-box-icon"><i class="fa fa-file-pdf-o" style="font-size:60px;margin-top:16px;"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Imprimir</span>
    ...
    @endif
        ...
        <a href="#">
            <div class="info-box bg-aqua">
                <span class="info-box-icon"><i class="fa fa-camera" style="font-size:60px;margin-top:16px;"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">Consultar las</span>
                    <span class="info-box-number">fotografia</span>
...
<div class="col-lg-6 col-md-6 connectedSortable">
    ...
    <div class="nav-tabs-custom" style="margin-right:18px;padding:18px;">
        <div class="nav-tabs-custom" style="padding: 16px;">
            <center><h4>Requerimiento de materiales</h4></center>
        ...
        <div class="modal fade" id="apro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <textarea class="form-control" rows="3" name="observacionAprobado" maxlength="300" id="observacionAprobado"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    <input type="submit" class="btn btn-success" value="Aprobada la ejecución">
                </div>
                </div>
            </div>
        </div>
    ...
    <form action="{{ route('operador.eliminarEjecucion', $folio->id) }}" method="POST">
        ...
        <div class="modal fade" id="repro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <textarea class="form-control" rows="3" name="observacionReprobado" maxlength="300" id="observacionReprobado"></textarea>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    <input type="submit" class="btn btn-danger" value="Cancelado por el cliente">
                </div>
                </div>
            </div>
        </div>
...
<script src="{{ asset('js/operator/cierre.js') }}"></script>
<script>
    var img = "{{ url('imagenes/sistemas/icono1-pdf.png') }}";
    function lista(url){
        $('#example').DataTable({
            serverSide:true,
            ajax: url,
